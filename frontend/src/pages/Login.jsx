...
export default function Login() {
  ...
  const renderInput = (id, type, placeholder, error) => (
    <div>
      ...
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-slate-800 dark:text-slate-100 rounded-2xl shadow-xl p-8 border border-slate-200 dark:border-slate-700 transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {renderInput("email", "email", "Enter your email", errors.email)}
            {renderInput("password", "password", "Enter your password", errors.password)}
